...
```{r}
states <- us_states() %>%
  filter(!(state_abbr %in% c("PR", "AK", "HI")))  #Fiter out three states (Alaska, Hawaii, Puerto Rico)
...
How many rows above? Why?  2,555 = 365 (day in a year) X 7 (parameters)
